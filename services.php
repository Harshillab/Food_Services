...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  ...
  <!-- <img src="24-7/24-7-3.jpg" width="100%"> -->
    <div class="carousel-item active">
      <img class="d-block w-100" src="24-7/24-7-3.jpg" alt="First slide" height="100%">
    
	</div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/f1.jpg" alt="Second slide" height="100%">
