                  ...
                  <!--add Product-->
                        <form action="" method="post" enctype="multipart/form-data">
                                     ...
                                     <label for="food_name">Food Name:</label>
                                            <input type="text" class="form-control" id="food_name" value="<?php if(isset($rfoodname)) { echo $rfoodname;}?>" placeholder="Enter Food Name" name="food_name" >
                                     ...
                                     <div class="form-group"><!--cost-->
                                            ...
                                            <input type="number" class="form-control" id="cost"  value="<?php if(isset($rcost)) { echo $rcost;}?>" placeholder="10000" name="cost" >
	                                 ...
	                                 <div class="form-group"><!--cuisines-->
                                            ...
                                            <input type="text" class="form-control" id="cuisines" value="<?php if(isset($rcuisines)) { echo $rcuisines;}?>" placeholder="Enter Cuisines" name="cuisines" >
                                    ...
                                    <button type="submit" name="update" class="btn btn-outline-primary">Update Item</button>
									<button type="submit" name="products" class="btn btn-outline-primary"><a href="food.php" style = "text-decoration:none;">Product Details</a></button>
									<br>
