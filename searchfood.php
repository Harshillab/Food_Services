...
<div class="row">
   ...
   <?php
	  ...
	  <div class="container-fluid">
		 ...
		 <div><i class="fas fa-rupee-sign"></i><span style="color:green; font-size:20px;"> <?php echo $res['cost']; ?></span></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 <form method="post">
		 <div> <button style = "text-align:left;padding:10px; font-size:15px;" type="submit" name="addtocart" class = "btn btn-primary" value="<?php echo $fid; ?>")" >Add to Cart</button></div>
		 </form>
		 </div>
