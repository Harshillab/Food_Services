...
<nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:white; font-family: 'Permanent Marker', cursive;">
      Food Services</span></a>
...
<div class="middle" style="padding:40px; border:1px solid #2188ff; margin:0px auto; width:400px;">
       <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#2188ff;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" id="home-tab" data-toggle="tab" href="#login" role="tab" aria-controls="home" aria-selected="true">Admin</a>
          </li>
            ...
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
			  ...
			  <form method="post" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                     ...
                     <input type="password" name="pswd" class="form-control" id="pwd" placeholder = "Enter Password" required/>
                   </div>
 
                  <button type="submit" name="login" style=" border:1px solid #BDDEFD;" class="btn btn-outline-primary">Log In</button>
