...
$query = mysqli_query($con,"update tblvendor set fld_name='$fn',fld_email='$emm',fld_address='$add',fld_mob='$mob',fld_password='$pwsd' where fld_email='$id'");	
if($query){
...
p {
  ...
  margin-top: 0px;
	...
	<body>
     ...
     <img src="our_image/clock.gif" width="20%"/></div>
	   <h1><time>00</time></h1>
<script>
